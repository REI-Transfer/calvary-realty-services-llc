...
export async function POST(request: Request) {
  try {
    ...
    try {
      const GF_CREDENTIAL_ID = process.env.GOFUNNEL_WEBHOOK_CREDENTIAL_ID || "3df0ce08-d97e-4f32-a560-41e040140bc7"
      const GF_BEARER = process.env.GOFUNNEL_WEBHOOK_SECRET || "7dda60c8-c30f-472b-8eb8-9d45b79e1dbd"
      if (GF_CREDENTIAL_ID && GF_BEARER) {
        ...
        const gfPayload = {
          ...
          sid: gfSid || undefined,
          formId: "calvary-realty-services-llc-survey",
          formTitle: "Calvary Realty Services LLC Survey",
